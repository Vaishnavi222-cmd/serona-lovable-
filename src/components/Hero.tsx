...
const Hero = () => {
  ...
  return (
    <section className="min-h-[40vh] md:min-h-[70vh] flex items-center justify-center relative overflow-hidden bg-serona-dark px-4 md:px-6 py-8 md:py-16">
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center" ref={contentRef}>
          <div className="mb-6 md:mb-10 pt-4 md:pt-0">
            <Brain className="w-16 h-16 md:w-20 md:h-20 mx-auto text-serona-primary animate-pulse" />
          </div>
          
          <h1 className="text-4xl md:text-7xl font-bold text-serona-secondary mb-6 md:mb-8 opacity-0 animate-fade-up" style={{ animationDelay: '0.3s' }}>
            Welcome to Serona AI
          </h1>
          
          <p className="text-lg md:text-2xl text-serona-secondary/80 max-w-3xl mx-auto mb-8 md:mb-12 opacity-0 animate-fade-up" style={{ animationDelay: '0.6s' }}>
          ...
          <div className="opacity-0 animate-fade-up mb-6 md:mb-8" style={{ animationDelay: '0.9s' }}>
            <Link
              to="/chat"
